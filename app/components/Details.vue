            ...
            <StackLayout col="0" row="0" backgroundColor="#f8f8f8">
                <GridLayout id="detail-page-background" columns="*" rows="auto,*,auto" height="200">
                    ...
                    <GridLayout columns="auto,*,auto" rows="auto" col="0" row="2" marginBottom="20">
                        <Label col="0" row="0" class="font-weight-bold" paddingLeft="20" fontSize="30" color="#FFFFFF"
                               text="Taylor Swift"></Label>
                    ...
                    <v-template>
                        <GridLayout @tap="onItemTap" orientation="horizontal" class="list-group-item" rows="auto" columns="auto,*,auto">
                            ...
                            <StackLayout col="1" row="0" marginLeft="15">
                                <Label marginTop="5" paddingRight="5" :text="item.title" class="list-group-item-heading font-weight-bold"
                                       color="#333333"></Label>
                                <Label marginTop="5" :text="item.artist" color="#999999"></Label>
                                <Label marginTop="5" :text="item.year" color="#999999"></Label>
                            </StackLayout>
                            <Label col="2" row="0" horizontalAlignment="right" color="#b9b9b9" fontSize="24" paddingRight="5" class="fa"> {{
                                'fa-ellipsis-v' | fonticon }}</Label>
                        </GridLayout>
                    </v-template>
                </ListView>
            </StackLayout>
