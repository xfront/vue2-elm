    ...
    <section id='foot_guide'>
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
            ...
            <defs>
                ...
                <symbol xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40"
                        id="msiteActive">
                    <defs>
                    ...
                    <g fill="none" fill-rule="evenodd">
                        <g transform="translate(1 1)">
                            ...
                            <use stroke="url(#index.18edf5a_d)" stroke-width="2"
                                 mask="url(#index.18edf5a_e)" xlink:href="#index.18edf5a_a"></use>
                        </g>
                        <g transform="translate(1 1)">
                            <use fill="url(#index.18edf5a_c)" xlink:href="#index.18edf5a_b"></use>
                            <use stroke="url(#index.18edf5a_d)" stroke-width="1.4"
                                 mask="url(#index.18edf5a_f)" xlink:href="#index.18edf5a_b"></use>
                        </g>
                    </g>
                </symbol>
                ...
                <symbol xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" id="find">
                    <defs>
                        ...
                        <mask id="discover-regular.8ef537f_b" width="40" height="40" x="0" y="0"
                              fill="#fff">
                ...
                <symbol xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40"
                    ...
                    <g fill="none" fill-rule="evenodd">
                        <use stroke="#3190e8" stroke-width="4"
                ...
                <symbol xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 38 38" id="order">
                    <defs>
                        ...
                        <mask id="order-regular.41c17f8_b" width="38" height="38" x="0" y="0"
                              fill="#fff">
                ...
                <symbol xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 38 38" id="profile">
                    <defs>
                        ...
                        <mask id="profile-regular.c151d62_c" width="18" height="21" x="0" y="0"
                              fill="#fff">
                        ...
                        <mask id="profile-regular.c151d62_d" width="38" height="16" x="0" y="0"
                              fill="#fff">
